...
blk_his_2016_2018 %>%
  ggplot(aes(x = reorder(major, students), y = students, fill = year)) + 
    ...
    labs(title = "Black and Hispanic Sophomores in SEAS in 2016 Compared to \n Students Receiving Degrees in 2018",
         subtitle = "Comparing the Retention of Harvard SEAS Black and Hispanic Students \n from 2016 to 2018",
         x = "Major", y = "Students") + 
    theme_classic() + coord_flip() +
...
female_2016_2018 %>%
  ggplot(aes(x = reorder(major, students), y = students, fill = year)) + 
    ...
    labs(title = "Female Sophmores in SEAS in 2016 Compared to \n Seniors Receiving Degrees from SEAS in 2018",
         subtitle = "Comparing the Retention of Harvard SEAS Female Students \n from 2016 to 2018",
         x = "Major", y = "Students") + 
    theme_classic() + coord_flip() +
    scale_fill_discrete(name = "Year")
