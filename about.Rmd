...
blk_2016_2018$year <- as.factor(blk_2016_2018$year)

blk_plot <- blk_2016_2018 %>%
  ggplot(aes(x = year, y = students, group = major, color = major)) + 
    ...
    labs(title = "Black Sophomores in SEAS in 2016 Compared to \nStudents Receiving Degrees in 2018",
         ...
         x = "Year", y = "Students", color = "Major") + theme_classic() +
    transition_reveal(along = students)
