...
# Saved the plot with all of the schools to include in my Shiny App

ggsave(filename = "final_project_shiny/race_all_plot.png", plot = race_all_plot)
```
...
ggsave(filename = "final_project_shiny/gender_all_plot.png", plot = gender_all_plot)
```
...
# Saved the plot to include in my Shiny App

ggsave(filename = "final_project_shiny/blk_plot.png", plot = blk_plot)
```

```{r hispanic retention, echo = FALSE}
...
ggsave(filename = "final_project_shiny/his_plot.png", plot = his_plot)
```

```{r white retention, echo = FALSE}
...
ggsave(filename = "final_project_shiny/wht_plot.png", plot = wht_plot)
```

```{r asian retention, echo = FALSE}
...
ggsave(filename = "final_project_shiny/asi_plot.png", plot = asi_plot)
```

```{r female retention, echo = FALSE}
...
ggsave(filename = "final_project_shiny/female_plot.png", plot = female_plot)
```

```{r male retention, echo = FALSE}
...
# Saved the final plot to include in my Shiny App

ggsave(filename = "final_project_shiny/male_plot.png", plot = male_plot)
```

```{r race model, echo = FALSE}
...
ggsave(filename = "final_project_shiny/blk_his_reg_plot.png", plot = blk_his_reg_plot)
```

```{r gender model, echo = FALSE}
...
ggsave(filename = "final_project_shiny/female_reg_plot.png", plot = female_reg_plot)
```
